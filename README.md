...
1. (Опционально) Откройте DevTools в браузере и на вкладке Network включите троттлинг
2. Перейдите по ссылке https://oauth.yandex.ru/authorize?response_type=token&client_id=23cabbbdc6cd418abb4b39c32c41195d
3. Авторизуйтесь при необходимости и предоставьте доступ
...
6. Введите токен в приложении - данные загрузятся автоматически!
